...
def Agrupar(cedula, name, age, ahorros, passw, bits):
    
    Datos.append('\n' + str(cedula) + ", " + str(name) + ", " + str(age)+ ", " + str(ahorros) + ", " + str(passw) + ", " + str(bits))
...
if Opt == 1:
    ...
    #----------------------------- CONDICIONES:
        ...
        if choise == 'y':
            ...
            Agrupar(cedula, name, age, ahorros, passw, bits)
        ...
        #----------------------------- GRADO ACADEMICO (2 bits):
            ...
            while True:
                ...
                if passw != passw2:
                    ...
                    break
        #-----------------------------
            Datos.append(str(cedula) + ", " + str(name) + ", " + str(age)+ ", " + str(ahorros) + ", " + str(passw) + ", " + str(bits) + '\n')
